...
function addComparisonAmounts(amounts: Set<string>, value: PeriodComparisonValue): void {
...
export function validateFinancialGrounding(
  ...
  const { amounts, counts, dates } = collectAllowedFacts(result);
